...
export default function DiningList({ onLocate }: DiningListProps) {
  ...
  const normalizeDiningItem = (shop: any) => {
    ...
    const categoryMap: Record<string, string> = {
      ...
      el: "Restaurant & Hotel",
      gangnam: "Korean BBQ",
      horizon: "Filipino & Spanish Cuisine",
