...
export default function DiningList({ onLocate }: DiningListProps) {
  ...
  const STATIC_DINING = [
    ...
    { id: "horizon", name: "Horizon Seaside Restaurant", location: "Brgy. Lonos", address: "Brgy. Lonos", category: "Seafood & Grill", image_url: "/dining/horizon.jpg", images: ["/dining/horizon.jpg"], menus: ["/dining/menu/horizon.jpg", "/dining/menu/horizon1.jpg"], contact: "0915 771 8481", latitude: 12.5728, longitude: 122.2514 },
    ...
    { id: "mamalois", name: "Mama Lois Kitchen", location: "Brgy. Lonos", address: "Brgy. Lonos", category: "Local Diner", image_url: "/dining/mamalois.jpg", images: ["/dining/mamalois.jpg"], menus: ["/dining/menu/mamalois1 (1).jpg", "/dining/menu/mamalois1 (2).jpg"], contact: "0900 000 0000", latitude: 12.5701, longitude: 122.2560 /* TODO: Mama Loi's full number */ },
    { id: "ocean", name: "Ocean View Seafood Grill", location: "Brgy. Ginablan", address: "Brgy. Ginablan", category: "Seafood Restaurant", image_url: "/dining/ocean.jpg", images: ["/dining/ocean.jpg"], menus: ["/dining/menu/seaview (1).jpg", "/dining/menu/seaview (2).jpg", "/dining/menu/seaview (3).jpg", "/dining/menu/seaview (4).jpg", "/dining/menu/seaview (5).jpg", "/dining/menu/seaview (6).jpg"], contact: "0999 433 1224", latitude: 12.5291, longitude: 122.2608 },
    ...
    { id: "yurich", name: "Yurich Food House", location: "Brgy. Ginablan", address: "Brgy. Ginablan", category: "Local Restaurant", image_url: "/dining/yurich.jpg", images: ["/dining/yurich.jpg"], menus: ["/dining/menu/yurich (1).jpg", "/dining/menu/yurich (2).jpg", "/dining/menu/yurich (3).jpg", "/dining/menu/yurich (4).jpg", "/dining/menu/yurich (5).jpg", "/dining/menu/yurich (6).jpg", "/dining/menu/yurich (7).jpg", "/dining/menu/yurich (8).jpg", "/dining/menu/yurich (9).jpg", "/dining/menu/yurich (10).jpg", "/dining/menu/yurich (11).jpg", "/dining/menu/yurich (12).jpg"], contact: "0900 000 0000", latitude: 12.5291, longitude: 122.2608 /* TODO: Yurich full number */ },
  ];
