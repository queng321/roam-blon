...
const STATIC_DINING = [
  ...
  { id: "horizon", name: "Horizon Seaside Restaurant", address: "Brgy. Lonos", description: "Beachfront dining with panoramic ocean views and fresh grilled seafood.", category: "Seafood & Grill", image_url: "/dining/horizon.jpg", images: ["/dining/horizon.jpg"] },
