...
const STATIC_DINING = [
  ...
  { id: "horizon", name: "Horizon Seaside Restaurant", address: "Brgy. Lonos", description: "Ross's Restaurant offers Filipino & Spanish cuisine by Horizon Hotel Romblon. Experience the rich flavors of the Philippines with a touch of Spanish culinary heritage—from beloved Filipino comfort food to Spanish-inspired favorites, every dish is thoughtfully prepared to bring together tradition, flavor, and modern dining, served with the warm hospitality Romblon is known for. \"Where Every Bite Becomes Part of Your Romblon Story.\"", category: "Filipino & Spanish Cuisine", image_url: "/dining/horizon.jpg", images: ["/dining/horizon.jpg"], menus: ["/dining/menu/horizon (1).jpg", "/dining/menu/horizon (2).jpg", "/dining/menu/horizon (3).jpg", "/dining/menu/horizon (4).jpg", "/dining/menu/horizon (5).jpg"] },
