              ...
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-sm">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      <h3 className="text-2xl font-black italic uppercase text-[#111]">Top 10 Most Visited Tourist Destinations</h3>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Ranked by QR scan visits</p>
                    </div>
                    <span className="ml-auto px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase tracking-widest">
                      Live
                    </span>
                  </div>
                  {allDestinationsSeries.length === 0 ? (
                    <p className="text-slate-300 text-xs italic text-center py-8">No QR scans yet.</p>
                  ) : (
                        ...
                        <div key={idx} className="flex items-center gap-4 p-3 rounded-2xl hover:bg-slate-50 transition-all">
                          ...
                          <div className="w-40 hidden sm:block h-1.5 bg-slate-100 rounded-full overflow-hidden flex-shrink-0">
                            <div
                              ...
                              style={{
                                width: `${Math.min((d.count / (allDestinationsSeries[0]?.count || 1)) * 100, 100)}%`,
                                background: POINT_COLORS[idx % POINT_COLORS.length],
                              }}
                            />
                          </div>
                ...
                {/* Top 10 most visited dining spots */}
                <div className="bg-white rounded-[3rem] p-10 border border-slate-100 shadow-sm">
                  <div className="flex items-center gap-3 mb-8">
                    <div className="h-10 w-10 bg-orange-50 rounded-xl flex items-center justify-center text-orange-500">
                      <Trophy size={20} />
                    ...
                    <div>
                      <h3 className="text-2xl font-black italic uppercase text-[#111]">Top 10 Most Visited Dining Spots</h3>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Ranked by QR scan visits</p>
                    </div>
                    <span className="ml-auto px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase tracking-widest">
                      Live
                        ...
                        <div key={idx} className="flex items-center gap-4 p-3 rounded-2xl hover:bg-slate-50 transition-all">
                          ...
                          <div className="w-40 hidden sm:block h-1.5 bg-slate-100 rounded-full overflow-hidden flex-shrink-0">
                            <div
                              className="h-full rounded-full"
                              style={{
                                width: `${Math.min((d.count / (allDiningSeries[0]?.count || 1)) * 100, 100)}%`,
                                background: POINT_COLORS[idx % POINT_COLORS.length],
                              }}
                            />
                          </div>
...
<td className="py-6 px-4">
            ...
            {activeTab === 'qr_generator' && (
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {(() => {
                  const STATIC_DINING = [
                    { id: "bistro", name: "Marble City Café & Bistro", location: "Town Proper", address: "Town Proper, Romblon", category: "Café & Bistro", image_url: "/dining/bistro.jpg" },
                    { id: "el", name: "El Hotel & Restaurant", location: "Romblon Town", address: "Romblon Town", category: "Restaurant", image_url: "/dining/el.jpg" },
                    { id: "gangnam", name: "Gangnam Korean Grill", location: "Romblon Town", address: "Romblon Town", category: "Korean BBQ", image_url: "/dining/gangnam.jpg" },
                    { id: "horizon", name: "Horizon Seaside Restaurant", location: "Brgy. Lonos", address: "Brgy. Lonos", category: "Seafood & Grill", image_url: "/dining/horizon.jpg" },
                    { id: "italian", name: "Italian Trattoria", location: "Town Proper", address: "Town Proper", category: "Italian & Pizza", image_url: "/dining/italian.jpg" },
