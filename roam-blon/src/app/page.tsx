    ...
    async function checkSession() {
      try {
        ...
        if (user) {
          ...
          // Already viewing the tourist dashboard (cached session restored) — stay here
          // and don't bounce to a role dashboard on refresh.
          if (hadCachedTourist && cachedUser) {
            const touristData = JSON.parse(cachedUser);
      ...
      {view === "landing" && (
        <section className="fixed inset-0 z-[100] flex flex-col items-center justify-start bg-[#FAEEED] text-slate-800 pt-12 md:pt-20 text-center overflow-y-auto no-scrollbar relative">
          ...
          <div className="max-w-xl w-full px-6 animate-in fade-in zoom-in duration-1000 relative z-10">
            ...
            <p className="text-[10px] md:text-[11px] font-black text-slate-400/80 tracking-wide mb-12 uppercase">This is a Capstone Project of 4th year BSIT Students of RSU - Romblon Campus</p>
