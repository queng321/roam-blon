...
function QRScanContent() {
  ...
  const getStaticBeach = (beachId: string) => {
    const STATIC: Record<string, any> = {
      ...
      "sd-peable": { id: "sd-peable", name: "Pebble Walk Beach Resort", location: "Brgy. Ginablan, Romblon", description: "A wide, white-sand haven perfect for long stays with cozy cottages and towering palm trees.", image_url: "/beach&resorts/peabble.jpg" },
      ...
      "sd-dc-logbon": { id: "sd-dc-logbon", name: "DC Munting Paraiso", location: "Brgy. Agnay, Romblon", description: "A serene hideaway in Brgy. Agnay where fine white sand meets calm turquoise water. Fringed by coconut palms and shaded day cottages, it's the perfect spot to unwind, swim, and feast on fresh seafood grilled by the shore.", image_url: "/beach&resorts/dc.webp" },
      ...
      "sd-horizon": { id: "sd-horizon", name: "Horizon Hotel Romblon", location: "Brgy. Lonos, Romblon", description: "A stunning beachfront resort offering panoramic sea views, comfortable accommodations, and easy access to the best shores.", image_url: "/beach&resorts/horizon1.jpg" },
  ...
  const getStaticDining = (diningId: string) => {
    const STATIC: Record<string, any> = {
      ...
      "horizon": { id: "horizon", name: "Horizon Seaside Restaurant", location: "Brgy. Lonos, Romblon", address: "Brgy. Lonos", category: "Filipino & Spanish Cuisine", description: "Ross's Restaurant offers Filipino & Spanish cuisine by Horizon Hotel Romblon. Experience the rich flavors of the Philippines with a touch of Spanish culinary heritage—from beloved Filipino comfort food to Spanish-inspired favorites, every dish is thoughtfully prepared to bring together tradition, flavor, and modern dining, served with the warm hospitality Romblon is known for. \"Where Every Bite Becomes Part of Your Romblon Story.\"", image_url: "/dining/horizon.jpg", images: ["/dining/horizon.jpg"], opening_time: "11:00 AM", closing_time: "9:00 PM" },
