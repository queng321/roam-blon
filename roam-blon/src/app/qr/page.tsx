...
function QRScanContent() {
  ...
  const getStaticBeach = (beachId: string) => {
    const STATIC: Record<string, any> = {
      ...
      "sd-dc-logbon": { id: "sd-dc-logbon", name: "DC Munting Paraiso", location: "Logbon Island, Romblon", description: "A beautiful and relaxing white sand beach located on Logbon Island.", image_url: "/beach&resorts/dc.webp" },
